  ...
  const generateProceduralArt = async () => {
    ...
    try {
      const colorSchemeMap: Record<string, string[]> = {
        ...
        pastel: ['#FFB3BA', '#FFCCCB', '#FFFFBA', '#BAE1FF', '#BAC2F0'],
        dark: ['#1a1a1a', '#333333', '#555555', '#777777', '#999999'],
        neon: ['#FF006E', '#FFBE0B', '#00F5FF', '#00FF41', '#FF006E'],
      };
      ...
      const imageData = await ProceduralGeneratorService.generateArt({
        ...
        colorScheme: colorSchemeMap[proceduralSettings.colorScheme] || colorSchemeMap.vibrant,
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      max="3"
                      value={proceduralSettings.complexity === 'simple' ? 1 : proceduralSettings.complexity === 'moderate' ? 2 : 3}
                      onChange={(e) => {
                        const val = parseInt(e.target.value);
                        const complexityMap = { 1: 'simple', 2: 'moderate', 3: 'complex' } as const;
                        setProceduralSettings({ ...proceduralSettings, complexity: complexityMap[val as 1 | 2 | 3] });
                      }}
                      className="w-full"
                    />
                  </div>
