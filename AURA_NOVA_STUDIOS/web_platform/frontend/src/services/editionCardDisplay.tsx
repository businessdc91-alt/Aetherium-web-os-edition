...
// ================== RARITY COLORS ==================
export const RARITY_COLORS: Record<CardRarity, { bg: string; border: string; text: string; glow: string }> = {
  starter: {
...
export function EditionCardDisplay({
  ...
  const rarity = instance?.rarity || card.rarity || 'common';
